...
public class Conexion {
    ...
    private static String login = "USUARIO_JUGUETERIA"; // Usuario de la base de datos
    private static String clave = "13579"; // Contraseña de la base de datos
    ...
    public static Connection getConnection() {
        try {
            ...
            System.out.println("======================================================");
            System.out.println("✅ Litman Enrique Portillo Colque");
            System.out.println("======================================================");
